<?php
    ...
    <section id="<?= $id ?>" class="bg-gray-800 bg-cover">
        <main class="main-container component-container services-container">
            ...
            <div class="flex md:col-span-2 lg:col-span-1">
                <?php foreach($services as $service): ?>
                    ...
                    <div class="service bg-gray-600 py-10 px-10 self-center w-full col-span-1 lg:ml-8 rounded-lg shadow-xl shadow-gray-900">
